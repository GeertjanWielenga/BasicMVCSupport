...
class EELevelPanelVisual extends JPanel {
    ...
    EELevelPanelVisual(J2eeModule.Type projectType) {
        ...
        getAccessibleContext().setAccessibleDescription("Settings");
    }
    ...
    void readSettings(WizardDescriptor d) {
        Profile eeLevel = (Profile) d.getProperty(JavaEEMVCWizardIterator.PROP_EE_LEVEL);
        if (eeLevel != null) {
    ...
    void storeSettings(WizardDescriptor d) {
        d.putProperty(JavaEEMVCWizardIterator.PROP_EE_LEVEL, j2eeVersion.getSelectedItem());
